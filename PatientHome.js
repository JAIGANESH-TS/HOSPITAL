...
import doc_img from './doctor12.png';
import 'mdbreact';
...
class PatientHome extends Component {
    ...
    componentDidMount(){
      ...
      axios.get('/patient/bill', {
        ...
        .then(res => {
          this.setState({
            medicine_cost: res.data.length > 0 ? res.data[0].medicine_cost : 0,
            misc_charge: res.data.length > 0 ?res.data[0].misc_charge : 0,
            room_charge: res.data.length > 0 ? res.data[0].room_charge : 0,
            operation_charge: res.data.length > 0 ? res.data[0].operation_charge : 0
          });
        })
    }

  ...
  {!isLoading ? patients.map(patient => {
    return (
      <div key={patient.patient_id} className="list-group-item"  style ={{backgroundColor:"#e0e0e0"}}>
        <p  className="mb-0" style ={{backgroundColor:"#e0e0e0"}}><i className="fab fa-slack-hash fa-2x mr-4 purple p-3 white-text rounded " aria-hidden="true"></i>Patient Name: {patient.first_name}</p>
        <p  className="mb-0" style ={{backgroundColor:"#e0e0e0"}}><i className="fab fa-slack-hash fa-2x mr-4 purple p-3 white-text rounded " aria-hidden="true"></i>Disease: {patient.disease}</p>
        </div>
    )
    }) : <h4>Loading</h4>}
  </div>
